    ...
    <>
        ...
        <Container>
          <div className="flex flex-col py-3 md:h-24 md:flex-row md:items-center md:justify-between md:py-0">
            ...
            <div className="flex w-full items-center justify-between">
              ...
              <div className="text-xl font-bold text-[#00c0ff] md:hidden">Logo</div>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-60 flex md:hidden">
          ...
          {/* Menu Content */}
          <div className="relative w-[75%] max-w-sm flex-col bg-(--bg) shadow-2xl transition-transform" dir="rtl">
            
            {/* Menu Header */}
            <div className="flex items-center justify-between border-b border-gray-100 p-4 dark:border-gray-800">
              <span className="text-lg font-bold text-[#00c0ff]">منوی کاربری</span>
              <button onClick={() => setIsOpen(false)} className="rounded-full p-1 hover:bg-gray-100 dark:hover:bg-white/10">
            ...
            <ul className="flex flex-col gap-2 p-4">
              <MobileNavItem to="/" label="صفحه اصلی" onClick={() => setIsOpen(false)} />
              <MobileNavItem to="/store" label="فروشگاه" onClick={() => setIsOpen(false)} />
            </ul>
              ...
              {user ? (
                <div className="flex flex-col gap-4">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-bold text-(--text)">{user.displayName}</span>
                  </div>
                  <button
